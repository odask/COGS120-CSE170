$(document).ready(function(){
  ...
  $("#search_button").click(function(){
    ...
    //use it to go directly to a map? idk
    ...
    else if (searchBar_input == "Restrooms"){
      window.location.href='restroom.html';
    }
    else if (searchBar_input == "Classrooms"){
      window.location.href='classroom.html';
    }
    else if (searchBar_input == "Study Rooms"){
      window.location.href='classroom.html';
    }
    else if (searchBar_input == "Foodcarts" || searchBar_input == "Nursing Rooms" || searchBar_input == "Restaurants"){
...
function autocomplete(inp, arr) {
  ...
  var testedPlaces = ["Price Center","Center Hall","Geisel Library","CSE","CSB","Cognitive Science Building","PC","Wells Fargo Building","Jacobs","Galbraith","Biomed Library", "Restrooms", "Classrooms", "Study Rooms", "Foodcarts", "Nursing Rooms","Restaurants"];
